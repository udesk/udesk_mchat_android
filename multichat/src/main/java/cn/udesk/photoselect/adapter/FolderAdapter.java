...
public class FolderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            if (folder != null) {
                UdeskUtil.loadIntoCustomerSize(context, folder.getFirstFilePath(),R.drawable.udesk_defualt_failure,
                        R.drawable.udesk_defalut_image_loading,contentHolder.iv_picture,UdeskUtil.dip2px(context, 80),
