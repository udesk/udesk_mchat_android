...
//            UdeskUtil.loadEmojiView(mContext, viewHolder.mImageView, Uri.fromFile(new File(stickerBitmapUri)), (int) mIvSize, (int) mIvSize);
            UdeskUtil.loadIntoCustomerSize(mContext,stickerBitmapUri,
                    R.drawable.udesk_multimerchant_defualt_failure,R.drawable.udesk_multimerchant_defalut_image_loading,
                    viewHolder.mImageView,(int) mIvSize, (int) mIvSize);
        }
