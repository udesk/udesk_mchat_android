...
public class UdeskMultimerchantSDKManager {
    ...
    public void setNavigationModes(List<UdeskMultimerchantNavigationMode> navigationModes) {
    ...
    public void setNavigationItemClickCallBack(IUdeskMultimerchantNavigationItemClickCallBack navigationItemClickCallBack) {
     ...
     */
    public void setExtraFunctions(List<UdeskMultimerchantFunctionMode> extraFunctions, IUdeskMultimerchantFunctionItemClickCallBack functionItemClickCallBack) {
     ...
     */
    public void setExtraFunctions(List<UdeskMultimerchantFunctionMode> extraFunctions) {
        this.extraFunctions = extraFunctions;
    }
     ...
     */
    public void setFunctionItemClickCallBack(IUdeskMultimerchantFunctionItemClickCallBack functionItemClickCallBack) {
        this.functionItemClickCallBack = functionItemClickCallBack;
    }
        ...
        try {
            if (customerInfo != null){
                ...
                if (TextUtils.isEmpty(customerInfo.getEuid())) {
                    Toast.makeText(context, context.getResources().getString(R.string.udesk_multimerchant_need_customer_unique_id), Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public String getRegisterId(Context context) {
        if (TextUtils.isEmpty(UdeskMultimerchantConfig.registerId)) {
        ...
        return UdeskMultimerchantConfig.registerId;
    }
