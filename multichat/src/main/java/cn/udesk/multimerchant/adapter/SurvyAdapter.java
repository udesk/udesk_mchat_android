...
import cn.udesk.multimerchant.model.OptionsModel;
...
public class SurvyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == UdeskConst.UdeskSurvyShowType.STAR) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.udesk_multimerchant_survy_type_star_item, parent, false);
            SurvyStarViewHolder starViewHolder = new SurvyStarViewHolder(view);
            view.setOnClickListener(this);
            return starViewHolder;
        } else if (viewType == UdeskConst.UdeskSurvyShowType.EXPRESSION) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.udesk_multimerchant_survy_type_express_item, parent, false);
            view.setOnClickListener(this);
            SurvyExpressionViewHolder expressionViewHolder = new SurvyExpressionViewHolder(view);
            return expressionViewHolder;
        } else {
            View view = LayoutInflater.from(mContext).inflate(R.layout.udesk_multimerchant_survy_type_text_item, parent, false);
            view.setOnClickListener(this);
        ...
        try {
            if (optionsModel != null) {
                ...
                if (holder instanceof SurvyTextViewHolder) {
                    ...
                    if (position == 0) {
                        expressionViewHolder.express.setImageResource(R.drawable.udesk_multimerchant_survy_statify);
                        expressionViewHolder.name.setText(mContext.getString(R.string.udesk_multimerchant_statify));
                    } else if (position == 1) {
                        expressionViewHolder.express.setImageResource(R.drawable.udesk_multimerchant_survy_common);
                        expressionViewHolder.name.setText(mContext.getString(R.string.udesk_multimerchant_common));
                    } else if (position == 2) {
                        expressionViewHolder.express.setImageResource(R.drawable.udesk_multimerchant_survy_unstatify);
                        expressionViewHolder.name.setText(mContext.getString(R.string.udesk_multimerchant_unstatify));
                    }
                    if (checkId == optionsModel.getId()) {
                        expressionViewHolder.name.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_color_333333));
                        expressionViewHolder.root.setBackgroundResource(R.drawable.udesk_multimerchant_express_pressed_bg);
                    } else {
                        expressionViewHolder.name.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_color_999999));
                        expressionViewHolder.root.setBackgroundResource(R.drawable.udesk_multimerchant_express_noraml_bg);
                    }
                    ...
                    if (checkId > 0 && optionsModel.getId() >= checkId) {
                        starViewHolder.star.setImageResource(R.drawable.udesk_multimerchant_star_on);
                    } else {
                        starViewHolder.star.setImageResource(R.drawable.udesk_multimerchant_star_off);
                    }
