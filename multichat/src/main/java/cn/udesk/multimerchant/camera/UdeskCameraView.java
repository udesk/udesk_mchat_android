package cn.udesk.multimerchant.camera;
...
import cn.udesk.multimerchant.camera.callback.CameraOpenOverCallback;
import cn.udesk.multimerchant.camera.callback.CameraView;
import cn.udesk.multimerchant.camera.callback.CaptureListener;
import cn.udesk.multimerchant.camera.callback.ErrorListener;
import cn.udesk.multimerchant.camera.callback.FocusCallback;
import cn.udesk.multimerchant.camera.callback.TypeListener;
import cn.udesk.multimerchant.camera.callback.UdeskCameraListener;
import cn.udesk.multimerchant.camera.state.CameraMachine;
...
public class UdeskCameraView extends FrameLayout implements CameraOpenOverCallback, SurfaceHolder
    ...
    private void initView() {
        try {
            ...
            View view = LayoutInflater.from(mContext).inflate(R.layout.udesk_multimerchant_camera_view, this);
            ...
            mCaptureLayout.setCaptureLisenter(new CaptureListener() {
                ...
                public void recordShort(final long time) {
                    mCaptureLayout.setTooShortWithAnimation(getResources().getString(R.string.udesk_multimerchant_too_short));
            ...
            mCaptureLayout.setTypeLisenter(new TypeListener() {
                ...
                public void cancel() {
                    ...
                    mCaptureLayout.setTextWithAnimation(getResources().getString(R.string.udesk_multimerchant_camera_view_tips));
