...
public class UdeskCameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.udesk_multimerchant_activity_small_camera);
        initView();
    }
    ...
    private void initView() {
        try {
            ...
            udeskCameraView.setFeatures(UdeskCameraView.BUTTON_STATE_ONLY_RECORDER);
            ...
            udeskCameraView.setErrorLisenter(new ErrorListener() {
                ...
                public void AudioPermissionError() {
                    ...
                    Toast.makeText(UdeskCameraActivity.this.getApplicationContext(), getString(R.string.udesk_multimerchant_audio_permission_error), Toast.LENGTH_SHORT).show();
                }
            });
