package cn.udesk.multimerchant.xmpp;
...
public class UdeskXmppManager implements ConnectionListener, StanzaListener {
                    ...
                    if (json.has("type")) {
                        ...
                        if (type.equals("message")) {
                            if (json.has("content")) {
                                ...
                                if (UdeskMultimerchantSDKManager.getInstance().getMessageArrived() != null) {
                                    UdeskMultimerchantSDKManager.getInstance().getMessageArrived().onNewMessage(receiveMessage);
                                }
                            }
    ...
    private synchronized void reConnected() {
        UdeskMultimerchantSDKManager.getInstance().getXmppExecutor().submit(new Runnable() {
