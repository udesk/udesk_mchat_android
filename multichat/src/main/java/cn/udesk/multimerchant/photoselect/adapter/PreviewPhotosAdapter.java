...
public class PreviewPhotosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.udesk_multimerchant_item_preview_photo, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            ...
            if (image != null) {
                ...
                UdeskUtil.loadInto(context,image.getPath(),R.drawable.udesk_multimerchant_defualt_failure,R.drawable.udesk_multimerchant_defalut_image_loading,contentHolder.iv_picture);
