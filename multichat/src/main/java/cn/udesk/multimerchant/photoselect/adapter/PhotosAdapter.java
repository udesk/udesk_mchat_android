package cn.udesk.multimerchant.photoselect.adapter;
...
import cn.udesk.multimerchant.photoselect.SelectResult;
...
public class PhotosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.udesk_multimerchant_photo_select_grid, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            if (image != null) {
                ...
                Drawable drawable = ContextCompat.getDrawable(context, R.drawable.udesk_multimerchant_video_icon);
                ...
                if (disPlayWidth > 0) {
                    UdeskUtil.loadIntoCustomerSize(context, path,R.drawable.udesk_multimerchant_defualt_failure,R.drawable.udesk_multimerchant_defalut_image_loading,
                            contentHolder.iv_picture,disPlayWidth / 4, UdeskUtil.dip2px(context, 100));
                } else {
                    UdeskUtil.loadIntoCustomerSize(context, path,R.drawable.udesk_multimerchant_defualt_failure,R.drawable.udesk_multimerchant_defalut_image_loading,
                            contentHolder.iv_picture,contentHolder.iv_picture.getWidth(), contentHolder.iv_picture.getHeight());
                }
    ...
    private void updateSelector(TextView tvSelector, View v_selector, boolean selected, LocalMedia localMedia) {
        if (selected) {
            ...
            tvSelector.setBackgroundResource(R.drawable.udesk_multimerchant_checkphoto_bg_select_true);
        } else {
            tvSelector.setBackgroundResource(R.drawable.udesk_multimerchant_checkphoto_bg_select_false);
            tvSelector.setText("");
