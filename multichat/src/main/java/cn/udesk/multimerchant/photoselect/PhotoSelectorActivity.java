...
import cn.udesk.multimerchant.photoselect.adapter.FolderAdapter;
import cn.udesk.multimerchant.photoselect.adapter.PhotosAdapter;
import cn.udesk.multimerchant.photoselect.decoration.GridSpacingItemDecoration;
import cn.udesk.multimerchant.photoselect.entity.LocalMedia;
import cn.udesk.multimerchant.photoselect.entity.LocalMediaFolder;
...
//            UdeskUtil.setOrientation(this);
            ...
            setContentView(R.layout.udesk_multimerchant_activity_select);
            initView();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            if (id == R.id.udesk_back_linear) {
                ...
                if (!UdeskUtils.isNetworkConnected(getApplicationContext())) {
                    UdeskUtils.showToast(getApplicationContext(), getString(R.string.udesk_multimerchant_has_wrong_net));
                    return;
                }
                sendPhotos();
            }
    ...
    public void onSelectorOutOfMax() {
        Toast.makeText(getApplicationContext(), getString(R.string.udesk_multimerchant_max_tips), Toast.LENGTH_SHORT).show();
    }
    ...
    private void setViewEneable() {
        try {
            if (SelectResult.isEmpty()) {
                sendto.setText(R.string.udesk_multimerchant_send_message);
                pre.setText(R.string.udesk_multimerchant_photo_pre);
                sendto.setEnabled(false);
                pre.setEnabled(false);
                pre.setTextColor(getResources().getColor(R.color.udesk_multimerchant_color_747578));
                sendto.setBackgroundColor(getResources().getColor(R.color.udesk_multimerchant_color_8045c01a));
            } else {
                sendto.setEnabled(true);
                pre.setEnabled(true);
                sendto.setText(getString(R.string.udesk_multimerchant_selector_action_done_photos, SelectResult.count(), UdeskConst.count));
                pre.setText(getString(R.string.udesk_multimerchant_selector_action_done_photo_pre, SelectResult.count()));
                sendto.setBackgroundColor(getResources().getColor(R.color.udesk_multimerchant_color_45c01a));
                pre.setTextColor(getResources().getColor(R.color.udesk_multimerchant_color_bg_white));
            }
