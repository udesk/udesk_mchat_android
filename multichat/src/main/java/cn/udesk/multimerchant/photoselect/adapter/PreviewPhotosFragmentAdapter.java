...
public class PreviewPhotosFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.udesk_multimerchant_privew_selected_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            ...
            UdeskUtil.loadIntoCustomerSize(context, path, R.drawable.udesk_multimerchant_defualt_failure,R.drawable.udesk_multimerchant_defalut_image_loading,
                    contentHolder.iv_picture, UdeskUtil.dip2px(context, 60), UdeskUtil.dip2px(context, 60));
