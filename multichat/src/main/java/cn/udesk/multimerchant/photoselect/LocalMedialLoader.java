                    ...
                    if (data != null) {
                        ...
                        if (count > 0) {
                            ...
                            if (allfiles.size() > 0) {
                                ...
                                allImageFolder.setName(activity.getString(R.string.udesk_multimerchant_img_video));
                                fileFolders.add(0, allImageFolder);
                            }
                            if (allvideos.size() > 0) {
                                allVideoFolder.setFirstFilePath(allvideos.get(0).getPath());
                                allVideoFolder.setMedia(allvideos);
                                allVideoFolder.setName(activity.getString(R.string.udesk_multimerchant_all_video));
