...
public class FolderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.udesk_multimerchant_folder_item_view, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            if (folder != null) {
                UdeskUtil.loadIntoCustomerSize(context, folder.getFirstFilePath(),R.drawable.udesk_multimerchant_defualt_failure,
                        R.drawable.udesk_multimerchant_defalut_image_loading,contentHolder.iv_picture,UdeskUtil.dip2px(context, 80),
                        UdeskUtil.dip2px(context, 80));
