...
public class UDPullGetMoreListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        try {
            ...
            llheader = (LinearLayout) inflater.inflate(R.layout.udesk_multimerchant_layout_get_more, null);
    ...
    private void changeHeaderViewByState() {
        try {
            ...
            case RELEASE_To_REFRESH:
                ...
                tvTips.setText(getResources().getString(R.string.udesk_multimerchant_release_to_get_more));
            ...
            case PULL_To_REFRESH:
                ...
                tvTips.setText(getResources().getString(R.string.udesk_multimerchant_get_more_history));
                break;

            case REFRESHING:

                pbLoading.setVisibility(View.VISIBLE);
                tvTips.setText(getResources().getString(R.string.udesk_multimerchant_loading_more));
