...
import cn.udesk.multimerchant.adapter.SurvyAdapter;
import cn.udesk.multimerchant.adapter.TagAdapter;
...
public class UdeskSurvyPopwindow extends PopupWindow {
    ...
    public UdeskSurvyPopwindow(final Activity context, final SurveyOptionsModel surveyOptions, final SumbitSurvyCallBack callBack) {
        ...
        mMenuView = inflater.inflate(R.layout.udesk_multimerchant_survy_view, null);
        ...
        this.setAnimationStyle(R.style.udesk_multimerchant_survy_anim);
            ...
            public void onClick(View view) {
                ...
                if (callBack != null && choiceOptionsModel != null) {
                    ...
                    if (choiceOptionsModel.getRemark_option().equals(UdeskConst.REMARK_OPTION_REQUIRED) && TextUtils.isEmpty(remarkEt.getText().toString())) {
                        Toast.makeText(context.getApplicationContext(), context.getString(R.string.udesk_multimerchant_summit_must_remark), Toast.LENGTH_LONG).show();
                        return;
                    }
