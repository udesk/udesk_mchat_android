package cn.udesk.multimerchant.widget;
...
public class HorVoiceView extends View {
	...
	public HorVoiceView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		paint = new Paint();
		TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.UdeskMultimerchantVoiceView);
		color = mTypedArray.getColor(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_lineColor, Color.BLACK);
		lineWidth = mTypedArray.getDimension(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_lineWidth, 35);
		lineHeight = mTypedArray.getDimension(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_lineHeight, 4);
		maxLineheight = mTypedArray.getDimension(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_lineHeight, 32);
		textSize = mTypedArray.getDimension(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_textSize, 45);
		textColor = mTypedArray.getColor(R.styleable.UdeskMultimerchantVoiceView_udesk_multimerchant_textColor, Color.BLACK);
		mTypedArray.recycle();
	}
