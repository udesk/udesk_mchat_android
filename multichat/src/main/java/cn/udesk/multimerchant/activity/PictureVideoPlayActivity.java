...
//            UdeskUtil.setOrientation(this);
            setContentView(R.layout.udesk_multimerchant_activity_picture_videoplay);
            ...
            if (!TextUtils.isEmpty(path) && UdeskUtil.isExitFileByPath(this.getApplicationContext(), path)) {
                UdeskUtil.loadInto(getApplicationContext(), path, R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, video_img);
            } else if (UdeskUtil.fileIsExitByUrl(getApplicationContext(), UdeskConst.FileImg, path)) {
                UdeskUtil.loadInto(getApplicationContext(), Uri.fromFile(UdeskUtil.getFileByUrl(getApplicationContext(), UdeskConst.FileImg, path)).toString(),
                        R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, video_img);
            }
