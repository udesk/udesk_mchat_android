...
public class MessageAdatper extends BaseAdapter {
    private static final int[] layoutRes = {
            R.layout.udesk_multimerchant_chat_msg_item_txt_l,//文本消息左边的UI布局文件
            R.layout.udesk_multimerchant_chat_msg_item_txt_r,//文本消息右边的UI布局文件
            R.layout.udesk_multimerchant_chat_msg_item_audiot_l,//语音消息左边的UI布局文件
            R.layout.udesk_multimerchant_chat_msg_item_audiot_r,//语音消息右边的UI布局文件
            R.layout.udesk_multimerchant_chat_msg_item_imgt_l,//图片消息左边的UI布局文件
            R.layout.udesk_multimerchant_chat_msg_item_imgt_r,//图片消息右边的UI布局文件
            R.layout.udesk_multimerchant_chat_rich_item_txt,//富文本消息UI布局文件
            R.layout.udesk_multimerchant_im_commodity_item,  //显示推广链接信息的UI布局文件
            R.layout.udesk_multimerchant_chat_leavemsg_item_txt_l,//显示留言发送消息
            R.layout.udesk_multimerchant_chat_leavemsg_item_txt_r, // 显示收到留言消息的回复
            R.layout.udesk_multimerchant_chat_event_item, // 显示收到留言消息的回复
            R.layout.udesk_multimerchant_chat_msg_item_product_r, // 显示客户定义的商品消息
            R.layout.udesk_multimerchant_chat_msg_item_smallvideo_l,//短视频消息左
            R.layout.udesk_multimerchant_chat_msg_item_smallvideo_r,//短视频消息右
            R.layout.udesk_multimerchant_chat_msg_item_file_l,//文件消息左
            R.layout.udesk_multimerchant_chat_msg_item_file_r,//文件消息右
            R.layout.udesk_multimerchant_chat_msg_navigates_menu,//导航菜单消息
    };
            ...
            for (ReceiveMessage info : list) {
                if (!TextUtils.isEmpty(UdeskUtil.objectToString(message.getUuid())) &&
                    ...
                    if (message.getSend_status().equals("rollback")) {
                        ...
                        message.setContent(mContext.getString(R.string.udesk_multimerchant_rollback_tips));
                        break;
                    }
                    return;
                ...
                switch (itemType) {
                    ...
                    case LEAVEMSG_TXT_R:
                        ...
                        if (itemType == MSG_TXT_L) {
                            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMLeftTextColorResId, leaveMsgViewHolder.tvMsg);
                        } else if (itemType == MSG_TXT_R) {
                            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMRightTextColorResId, leaveMsgViewHolder.tvMsg);
                        }
                    ...
                    case MSG_TXT_R: {
                        ...
                        if (itemType == MSG_TXT_L) {
                            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMLeftTextColorResId, holder.tvMsg);
                        } else if (itemType == MSG_TXT_R) {
                            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMRightTextColorResId, holder.tvMsg);
                        }
                    ...
                    case RICH_TEXT: {
                        ...
                        UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMLeftTextColorResId, holder.rich_tvmsg);
                        convertView.setTag(holder);
                        break;
                    }
                    case MSG_AUDIO_L:
                    ...
                    case COMMODITY: {
                        ...
                        UdekConfigUtil.setUIbgDrawable(UdeskMultimerchantConfig.udeskCommityBgResId, holder.rootView);
                        UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskCommityTitleColorResId, holder.title);
                        UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskCommitysubtitleColorResId, holder.subTitle);
                        UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskCommityLinkColorResId, holder.link);
                        convertView.setTag(holder);
                        break;
                    }
                    case Udesk_Event:
                ...
                switch (itemType) {
                    ...
                    case MSG_FILE_R:
                        ...
                        if (TextUtils.isEmpty(UdeskMultimerchantConfig.customerUrl)){
                            ivHeader.setImageResource(R.drawable.udesk_multimerchant_im_default_user_avatar);
                        }else {
                            UdeskUtil.loadInto(mContext, UdeskMultimerchantConfig.customerUrl,R.drawable.udesk_multimerchant_im_default_user_avatar,R.drawable.udesk_multimerchant_im_default_user_avatar,ivHeader);
                        }
                        break;
                    case MSG_TXT_L:
                    case MSG_AUDIO_L:
                    ...
                    case NAVIGATES:
                        ...
                        if (merchant != null && !TextUtils.isEmpty(UdeskUtil.objectToString(merchant.getLogo_url()))) {
                            UdeskUtil.loadInto(mContext,UdeskUtil.objectToString(merchant.getLogo_url()),R.drawable.udesk_multimerchant_im_default_agent_avatar,R.drawable.udesk_multimerchant_im_default_agent_avatar,ivHeader);
                        } else {
                            ivHeader.setImageResource(R.drawable.udesk_multimerchant_im_default_agent_avatar);
                        }
                        if (merchant != null) {
...
//                        agentnickName.setText(message.getReplyUser());
    ...
    class AudioViewHolder extends BaseViewHolder {
            ...
            try {
                if (message.isPlaying) {
                    ...
                    record_play.setImageDrawable(mContext.getResources().getDrawable(
                            isLeft ? R.drawable.udesk_multimerchant_im_record_left_default : R.drawable.udesk_multimerchant_im_record_right_default));
                }
            } catch (Exception e) {
                e.printStackTrace();
            } catch (OutOfMemoryError error) {
        ...
        private void resetAnimationAndStart() {
            try {
                record_play.setImageDrawable(mContext.getResources().getDrawable(
                        isLeft ? R.drawable.udesk_multimerchant_im_record_play_left : R.drawable.udesk_multimerchant_im_record_play_right));
        ...
        void bind(Context context) {
            try {
                if (!TextUtils.isEmpty(message.getLocalPath()) && UdeskUtil.isExitFileByPath(context, message.getLocalPath())) {
                    UdeskUtil.loadIntoFitSize(context, message.getLocalPath(), R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, imgView,true);
                } else {
                    UdeskUtil.loadIntoFitSize(context, UdeskUtil.uRLEncoder(UdeskUtil.objectToString(message.getContent())), R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, imgView,true);
                }
    ...
    public class CommodityViewHolder extends BaseViewHolder {
        ...
        void bind(Context context) {
            try {
                    ...
                    rootView.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (UdeskMultimerchantSDKManager.getInstance().getCommodityCallBack() != null) {
                                UdeskMultimerchantSDKManager.getInstance().getCommodityCallBack().callBackProduct(item);
                            }
                        }
                    });
                } else {
                ...
                UdeskUtil.loadInto(context, UdeskUtil.uRLEncoder(item.getProduct().getImage()), R.drawable.udesk_multimerchant_defualt_failure,
                        R.drawable.udesk_multimerchant_defalut_image_loading, thumbnail);
        ...
        void bind(Context context) {
            try {
                ...
                if (TextUtils.isEmpty(jsonObject.optString("imgUrl"))) {
                    ...
                    UdeskUtil.loadInto(context, UdeskUtil.uRLEncoder(jsonObject.optString("imgUrl")), R.drawable.udesk_multimerchant_defualt_failure,
                            R.drawable.udesk_multimerchant_defalut_image_loading, imgView);
                }
                productUrl = jsonObject.optString("url");
                product_name.setText(jsonObject.optString("name"));
                if (!TextUtils.isEmpty(productUrl)) {
                    product_name.setTextColor(mContext.getResources().getColor(UdeskMultimerchantConfig.udeskProductNameLinkColorResId));
                    product_name.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (UdeskMultimerchantSDKManager.getInstance().getProductMessageWebonCliclk() != null) {
                                UdeskMultimerchantSDKManager.getInstance().getProductMessageWebonCliclk().txtMsgOnclick(productUrl);
                            } else {
                                Intent intent = new Intent(mContext, UdeskWebViewUrlAcivity.class);
        ...
        void bind(final Context context) {
            try {
                ...
                if (!TextUtils.isEmpty(message.getLocalPath()) && UdeskUtil.isExitFileByPath(mContext, message.getLocalPath())) {
                    ...
                    UdeskUtil.loadIntoFitSize(context, loaclpath, R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, imgView,true);
                } else {
                    if (!UdeskUtils.isNetworkConnected(mContext.getApplicationContext())) {
                        UdeskUtils.showToast(mContext.getApplicationContext(), mContext.getResources().getString(R.string.udesk_multimerchant_has_wrong_net));
                        return;
                    }
...
//                imgView.setTag(message.getTime());
            ...
            try {
                ...
                if (message.getDirection() == UdeskConst.ChatMsgDirection.Send) {
                    ...
                    if (message.getSendFlag() == UdeskConst.SendFlag.RESULT_SUCCESS) {
                        ...
                        operater.setText(mContext.getString(R.string.udesk_multimerchant_has_send));
                    } else {
                    ...
                    if (UdeskUtil.fileIsExitByUrl(mContext, UdeskConst.File_File, UdeskUtil.objectToString(message.getContent()))
                        ...
                        mProgress.setProgress(100);
                        operater.setText(mContext.getString(R.string.udesk_multimerchant_has_downed));
                    } else {
                        mProgress.setProgress(0);
                        operater.setText(mContext.getString(R.string.udesk_multimerchant_has_download));
                    }
                        ...
                        try {
                            ...
                            if (message.getDirection() == UdeskConst.ChatMsgDirection.Send) {
                                ...
                                if (file == null || UdeskUtil.getFileSizeQ(mContext.getApplicationContext(), file.getAbsolutePath()) <= 0) {
                                    Toast.makeText(mContext.getApplicationContext(), mContext.getString(R.string.udesk_multimerchant_has_uncomplete_tip), Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                    intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                            ...
                            if (!TextUtils.isEmpty(e.getMessage()) && e.getMessage().contains("No Activity found to handle Intent")) {
                                Toast.makeText(mContext.getApplicationContext(), mContext.getString(R.string.udesk_multimerchant_no_app_handle), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
        ...
        void bind(Context context) {
            try {
                ...
                if (result !=null && result.getData()!= null){
                    ...
                    final AbsCommonAdapter<NavigatesResult.DataBean.GroupMenusBean> adapter = new AbsCommonAdapter<NavigatesResult.DataBean.GroupMenusBean>(mContext,R.layout.udesk_multimerchant_navigates_menu_item){
                        ...
                        public void convert(AbsViewHolder helper, NavigatesResult.DataBean.GroupMenusBean item, int pos) {
                            ...
                            if (message.isNavigatesClickable()){
                                name.setBackgroundResource(R.drawable.udesk_multimerchant_navigate_menu_bg);
                                name.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_custom_dialog_sure_btn_color));
                            }else {
                                name.setBackgroundResource(R.color.udesk_multimerchant_white);
                                name.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_color_text_gray));
                            }
                        }
                    };
                    ...
                    if (message.isNavigatesClickable()){
                        previous.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_color_7878787));
                    }else {
                        previous.setTextColor(mContext.getResources().getColor(R.color.udesk_multimerchant_color_text_gray));
                    }
    ...
    private void initItemNormalView(View convertView, BaseViewHolder holder) {
        try {
            ...
            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMTimeTextColorResId, holder.tvTime);
            UdekConfigUtil.setUITextColor(UdeskMultimerchantConfig.udeskIMAgentNickNameColorResId, holder.agentnickName);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
            ...
            if (tag != null && tag instanceof SmallVideoViewHolder) {
                ...
                if (cache.message != null && msgId.equals(cache.message.getUuid())) {
                    if (UdeskUtil.fileIsExitByUrl(mContext, UdeskConst.FileImg, UdeskUtil.objectToString(cache.message.getContent()))) {
                        ...
                        UdeskUtil.loadIntoFitSize(mContext, loaclpath, R.drawable.udesk_multimerchant_defualt_failure, R.drawable.udesk_multimerchant_defalut_image_loading, cache.imgView,true);
        ...
        try {
            ...
            if (percent == 100) {
                if (fileViewHolder.message.getDirection() == UdeskConst.ChatMsgDirection.Send) {
                    fileViewHolder.operater.setText(mContext.getString(R.string.udesk_multimerchant_has_send));
                } else {
                    fileViewHolder.operater.setText(mContext.getString(R.string.udesk_multimerchant_has_downed));
                }
            } else {
            ...
            if (!isSuccess) {
                Toast.makeText(mContext.getApplicationContext(), mContext.getString(R.string.udesk_multimerchant_download_failure), Toast.LENGTH_SHORT).show();
                fileViewHolder.operater.setText(mContext.getString(R.string.udesk_multimerchant_has_download));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
