        ...
        try {
            ...
            navigationAdapter.setOnItemClickListener(new NavigationAdapter.OnRecyclerViewItemClickListener() {
                ...
                public void onItemClick(View view, NavigationMode data) {
                    if (UdeskSDKManager.getInstance().getNavigationItemClickCallBack()!= null && activity != null
                            && activity.getPresenter() != null) {
                        UdeskSDKManager.getInstance().getNavigationItemClickCallBack().callBack(activity.getApplicationContext(), activity.getPresenter(), data);
                    }
                }
            });
        } catch (Exception e) {
