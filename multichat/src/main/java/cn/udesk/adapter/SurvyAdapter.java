            ...
            if (optionsModel != null) {
                ...
                if (holder instanceof SurvyTextViewHolder) {
                    ...
                    if (checkId == optionsModel.getId()) {
                        expressionViewHolder.name.setTextColor(mContext.getResources().getColor(R.color.color_333333));
                        expressionViewHolder.root.setBackgroundResource(R.drawable.udesk_express_pressed_bg);
                    } else {
                        expressionViewHolder.name.setTextColor(mContext.getResources().getColor(R.color.color_999999));
