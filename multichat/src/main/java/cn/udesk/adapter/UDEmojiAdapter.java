...
public class UDEmojiAdapter extends BaseAdapter {
    ...
    public static int[] EMOJI_RESOURCE_ID_ARRAY = new int[]{
            ...
            R.drawable.udesk_029,
            R.drawable.udesk_030,
            R.drawable.udesk_031,
            R.drawable.udesk_032,
            R.drawable.udesk_033,
            R.drawable.udesk_034,
            R.drawable.udesk_035,
            R.drawable.udesk_036,
            R.drawable.udesk_037,
            R.drawable.udesk_038,
            R.drawable.udesk_039,
            R.drawable.udesk_040,
            R.drawable.udesk_041,
            R.drawable.udesk_042,
            R.drawable.udesk_043,
            R.drawable.udesk_044,
            R.drawable.udesk_045,
            R.drawable.udesk_046,
            R.drawable.udesk_047,
            R.drawable.udesk_048,
            R.drawable.udesk_049,
            R.drawable.udesk_050,
            R.drawable.udesk_051,
            R.drawable.udesk_052,
            R.drawable.udesk_053,
            R.drawable.udesk_054,
            R.drawable.udesk_055,
            R.drawable.udesk_056
    };
    ...
    public String getItem(int position) {
        try {
            if (position < 28){
                return "[emoji" + EMOJI_ARRAY[position+28] + "]";
            }else{
...
//	}
        ...
        try {
            ...
            if (position <=27){
                ((ImageView) convertView)
                        .setImageResource(EMOJI_RESOURCE_ID_ARRAY[position+28]);
            }else if (position == 28){
                ((ImageView) convertView)
                        .setImageResource(R.drawable.udesk_028);
            }
                ...
                for (int j = 0; j < EMOJI_ARRAY.length; j++) {
                    if (EMOJI_ARRAY[j].equals(emojiNumber)) {
                        ...
                        if (emojiNumber.equals("028")) {  //sdk 端最后一个表情替换成了删除，收到最后一个表情，做特殊处理
                            drawable = mContext.getResources().getDrawable(R.drawable.udesk_043);
                        }
                        if (drawable != null) {
    ...
    public static int getResDrawableID(Context mContext, String resName) {
        return mContext.getApplicationContext().getResources().getIdentifier(resName, "drawable",
