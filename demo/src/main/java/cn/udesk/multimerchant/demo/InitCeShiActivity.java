...
import cn.udesk.multimerchant.widget.UdeskLodingDialog;
...
//    String uuid = "f229226e-9881-4c27-8887-3d069de00852";
        ...
        if (view.getId() == R.id.udesk_start) {
            ...
            dialog.setOkTextViewOnclick(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    UdeskMultimerchantLocalManageUtil.saveSelectLanguage(getApplicationContext(),new Locale(editText.getText().toString().trim()));
                }
            });
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    UdeskMultimerchantSDKManager.getInstance().init(InitCeShiActivity.this, uuidEdit.getText().toString(), sign, String.valueOf(timestamp));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void showloadingDialog(String dialogTitle) {
        try {
            hideLodingDialog();
            lodingDialog = new UdeskLodingDialog(this, R.style.udesk_multimerchant_dialogstyle, R.layout.udesk_multimerchant_request_view, dialogTitle);
