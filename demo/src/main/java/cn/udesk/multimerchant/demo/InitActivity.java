...
//    String key = "a4db8cf1a0dd4abfad3fce02728f8357";
    ...
    private void testSign() {
        ...
        UdeskMultimerchantSDKManager.getInstance().init(InitActivity.this, uuid, sign, time);
    }
    ...
    public void showloadingDialog(String dialogTitle) {
        try {
            hideLodingDialog();
            lodingDialog = new UdeskLodingDialog(this, R.style.udesk_multimerchant_dialogstyle,
                    R.layout.udesk_multimerchant_request_view, dialogTitle);
